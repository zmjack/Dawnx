...
namespace Dawnx.Test
{
    public class DawnIPAddressTests
    {
        ...
        public void IPUtilityTest()
        {
            ...
            Assert.Equal(0x8f181424, IPUtility.GetLongString(IPAddress.Parse("143.24.20.36")));
            Assert.Equal(0x8f181425, IPUtility.GetLongString(IPAddress.Parse("143.24.20.37")));
