...
namespace System
{
    ...
    public static class XArray
    {
        ...
        /// <param name="this"></param>
        /// <returns></returns>
        public static string UrlSafeBase64String(this byte[] @this) => Base64.ConvertBase64ToUrlSafeBase64(Convert.ToBase64String(@this));
        ...
        /// <returns></returns>
        public static string HexString(this byte[] @this, string separator = "") => string.Join(separator, @this.Select(x => x.ToString("x2")));
